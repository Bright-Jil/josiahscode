...
public class DetailsActivity extends AppCompatActivity {
  ...
  static   String website;
    ...
    private void setupPieChart()
    {
        ...
        pchart.setDragDecelerationFrictionCoef(0.80f);
        pchart.setHoleColor(Color.GRAY);
        pchart.setTransparentCircleRadius(50f);
        ...
        values.add(new PieEntry(shares,"Total Shares Issued"));
        values.add(new PieEntry(capital,"GH Cedis"));
        ...
        pchart.setEntryLabelColor(Color.lightGray);
    ...
    private void setupLineChart()
    {
        ...
        lChart.setBackgroundColor(Color.lightGray);
